  ...
  return (
    ...
    >
      <div
        className={
          variant === "landing"
            ? "absolute inset-0 bg-cover bg-center bg-no-repeat opacity-[0.78] invert dark:opacity-[0.62] dark:invert-0"
      ...
      <div
        className={
          variant === "landing"
            ? "absolute inset-0 bg-background/28 dark:bg-background/40"
